class Solution:
    ...
    def isAlienSorted2(self, words: List[str], order: str) -> bool:  # Preferred solution
        ...
        for i in range(len(words)):
            ...
            if (
                word < prev
            ):  # We eliminate the 2nd pass at these words by checking previous. # My Notes: If the value of the second word is less than the first word, then it's not lexiconically sorted
                return False
            prev = word
        return True
